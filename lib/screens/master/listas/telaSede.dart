...
//import 'package:bistro/screens/master/cadastros/telaCadastroSalao.dart';
import 'package:bistro/screens/widgets/cores.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class CozinhaListScreen extends StatefulWidget {
  //final String? email;
  final String tipoUser;
  final String idUser;
  final BistroUser user;

  const CozinhaListScreen(
      {Key? key,
      //this.email,
  ...
  @override
  _CozinhaListScreenState createState() => _CozinhaListScreenState();
}

class _CozinhaListScreenState extends State<CozinhaListScreen> {
  String searchQuery = "";
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () => Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => SedeRegisterScreen(
            ...
            Expanded(
              child: StreamBuilder(
                ...
                builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  ...
                  if (clientes.isEmpty) {
                    return const Center(
                        child: Text('Nenhuma cozinha encontrada',
